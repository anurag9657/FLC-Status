...
<div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="addCase.jsp"><i class="fa fa-desktop "></i>Add New Case</a>
                    </li>
                    <li>
                        <a href="updateCase.jsp"><i class="fa fa-desktop "></i>Update Case</a>
                    </li>
                </ul>
  ...
  <div class="form">  
  <form action="AddCaseServlet" method="post" onsubmit='checkit()'>
